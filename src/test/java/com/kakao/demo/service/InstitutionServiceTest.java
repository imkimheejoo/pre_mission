...
class InstitutionServiceTest {
    ...
    private List<String> inputs = Arrays.asList("주택도시기금", "국민은행", "우리은행", "신한은행",
    ...
    void findInstitutions() {
        List<Institution> expectedResults = Arrays.asList(
                Institution.from("주택도시기금"),
                Institution.from("국민은행"),
                Institution.from("우리은행"),
                Institution.from("신한은행"),
                Institution.from("한국시티은행"),
                Institution.from("하나은행"),
                Institution.from("농협은행/수협은행"),
                Institution.from("외환은행"),
                Institution.from("기타은행"));
